      ...
      <div className="container">
          <Row>
              <Card title="Retro Nettside prosjekt/spill" center={true}>
                ...
                <a href="https://www.retro.sivert.priv.no/" className="btn btn-secondary">Se Prosjekt</a>
              </Card>
          ...
          <hr className="my-4"></hr>
              <Card title="Game Ratings" center={true}>
                ...
                <a href="https://www.prosjektoppgave.sivert.priv.no/" className="btn btn-secondary a- style">Se Prosjekt</a><a href="https://github.com/bjornsiv/Prosjektoppgave-H21" className="btn btn-secondary a-style">Se GitHub</a>
              </Card>

          <hr className="my-4"></hr>
              <Card title="Frontend sivert.priv.no" center={true}>
                ...
                <a href="https://github.com/bjornsiv/Front-end-sivert.priv.no" className="btn btn-secondary a-style">Se GitHub</a>
              </Card>
          <hr className="my-4"></hr>
              <Card title="Karakterkalkulator" center={true}>
                <p>Er en GPA kalkulator skrevet i python for å regne ut GPA med A-F skalaen brukt på høyskoler og universiteter</p>
                <a href="https://github.com/bjornsiv/GPA-calculator" className="btn btn-secondary a-style">Se GitHub</a>
              </Card>
          <hr className="my-4"></hr>
              <Card title="Mujaffa spillet" center={true}>
                ...
                <a href="https://www.pro.sivert.priv.no/1Prosjekter/mujaffa.html" className="btn btn-secondary">Se Prosjekt</a>
              </Card>
